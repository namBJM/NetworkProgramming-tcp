...
public class Client2210 {
    ...
    private static final String Q_CODE = "IVwcVeZc"; // Mã câu hỏi đề bài đã cho
    ...
    public static void main(String[] args) {
        try (Socket socket = new Socket(SERVER_IP, SERVER_PORT)) {
            ...
            // c. Đảo ngược chuỗi, mã hóa Base64, gửi kết quả lên server
     ...
     * vì socket còn cần dùng tiếp cho các lượt trao đổi sau.
     */
